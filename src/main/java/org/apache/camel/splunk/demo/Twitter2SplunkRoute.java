...
public class Twitter2SplunkRoute extends RouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("twitter://search?type=polling&keywords=gaga&delay=10&consumerKey={{consumerKey}}&consumerSecret={{consumerSecret}}&accessToken={{accessToken}}&accessTokenSecret={{accessTokenSecret}}")
			.log("${body}")
